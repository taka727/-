...
def study(PLACE,HIDDEN,EPOCH):
    ...
    #保存用のフォルダを作成
    new_dir_path = '/Users/konishitakashidai/Desktop/卒研/卒研プログラム/RNN/predictRNN'+str(n_epoch)+str(n_hidden)+PLACE
    ...
    for l in range(0,4):
      ...
      df_predicted_data.to_csv("/Users/konishitakashidai/Desktop/卒研/卒研プログラム/RNN/predictRNN"+str(n_epoch)+str(n_hidden)+PLACE+"/predictRNN"+str(n_epoch)+str(n_hidden)+TEST_periodstart[l]+'-'+TEST_periodend[l]+PLACE+".csv")
